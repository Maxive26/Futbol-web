...
function Partido({ data = [], pos = "", text = "Octavos de final" }) {
    ...
    for (let i = 0; i < data.length; i++) {
      for (let j = 0; j < data[i].leagueStandings.length; j++) {
        for (let team of data[i].leagueStandings[j]) {
          ...
          if (
            team.rank === rank &&
            team.group === `Ranking of third-placed teams`
          ) {
            return { name: team.team.name, logo: team.team.logo };
          }
        }
...
export default function LlavesEurocopa({ data }) {
  return (
    <>
      <div className="p-5 rounded-xl bg-blackBG relative w-auto xl:w-[1105px] min-w-auto overflow-auto scrollbar-thin scrollbar-thumb-greenCard scrollbar-track-grayPage">
        ...
        <div className=" w-4 h-44 top-[480px] left-[265px] border-t-2 border-r-2 border-b-2 border-greenCard absolute  rounded-r-lg">
          <div className="w-3 h-1 top-1/2 left-4 border-t-2  border-greenCard absolute "></div>
        </div>
        ...
        <div className=" w-4 h-44 bottom-[475px] left-[265px] border-t-2 border-r-2 border-b-2 border-greenCard absolute  rounded-r-lg">
          <div className="w-3 h-1 bottom-1/2 left-4 border-t-2  border-greenCard absolute "></div>
        </div>
        <div className="w-4 h-[380px] top-48 left-[540px] border-t-2 border-r-2 border-b-2 border-greenCard absolute  rounded-r-lg">
          <div className="w-3 h-1 left-4 bottom-1/2 border-t-2  border-greenCard absolute "></div>
        </div>
        <div className="w-4 h-[380px] bottom-48 left-[540px] border-t-2 border-r-2 border-b-2 border-greenCard absolute  rounded-r-lg">
          <div className="w-3 h-1 left-4 bottom-1/2 border-t-2  border-greenCard absolute "></div>
        </div>
        <div className="w-4 h-[730px] top-96 left-[813px] border-t-2 border-r-2 border-b-2 border-greenCard absolute  rounded-r-lg">
          <div className="w-3 h-1 left-4 bottom-1/2 border-t-2  border-greenCard absolute "></div>
        </div>
        <div className="h-auto w-[1060px] gap-10  grid grid-cols-4">
          <div className="flex flex-col justify-center gap-6 w-60">
            <Partido data={data} pos={{ team1: "1B", team2: "2G" }} />
            <Partido data={data} pos={{ team1: "1A", team2: "2C" }} />
            <Partido data={data} pos={{ team1: "1F", team2: "4G" }} />
            <Partido data={data} pos={{ team1: "2D", team2: "2E" }} />
            <Partido data={data} pos={{ team1: "1E", team2: "1G" }} />
            <Partido data={data} pos={{ team1: "1D", team2: "2F" }} />
            <Partido data={data} pos={{ team1: "1C", team2: "3G" }} />
            <Partido data={data} pos={{ team1: "2A", team2: "2B" }} />
          </div>
          <div className="flex flex-col justify-around gap-6 w-60">
            ...
            <Partido
              data={data}
              text={"Cuartos de final"}
              pos={{ team1: "1F", team2: "2D" }}
            />
            <Partido
              data={data}
              pos={{ team1: "3D", team2: "2F" }}
              text={"Cuartos de final"}
            />
            <Partido
              data={data}
              text={"Cuartos de final"}
              pos={{ team1: "1C", team2: "2A" }}
            />
          </div>
          <div className="flex flex-col justify-around gap-6 w-60">
            <Partido
              data={data}
              pos={{ team1: "1B", team2: "2D" }}
              text={"Semifinal"}
            />
            <Partido
              data={data}
              pos={{ team1: "3D", team2: "1C" }}
              text={"Semifinal"}
            />
          </div>
          <div className="flex flex-col justify-center gap-6 w-60">
